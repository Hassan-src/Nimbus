...
| 🪝 React Hooks  | Application logic and state               |
...
The interface is divided into reusable components rather than being
...
Used to manage interactive application state such as:
